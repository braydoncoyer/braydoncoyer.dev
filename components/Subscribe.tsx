...
export function Subscribe({ size }: Props) {
  ...
  //         autoComplete="email"
  //         required
  //         className="block w-full px-8 py-3 mr-4 bg-white border-gray-300 rounded-full shadow-sm dark:bg-midnight md:py-4 focus:ring-midnight dark:focus:ring-gray-100 sm:text-sm md:text-lg dark:border-gray-400"
  //       />
  //       <button
  //         className="items-center justify-center w-full px-6 py-2 font-medium text-gray-900 bg-gray-200 rounded-full md:inline-flex md:w-auto dark:bg-gray-700 dark:text-gray-100 general-ring-state"
  //         type="submit"
  //       >
  ...
  //         autoComplete="email"
  //         required
  //         className="block w-full px-8 bg-white border-gray-300 rounded-full shadow-sm dark:bg-dark md:py-3 focus:ring-midnight dark:focus:ring-gray-100 sm:text-sm md:text-base dark:border-gray-400"
  //       />
  //       <button
  //         className="absolute top-[-13px] right-[3px] md:right-[5px] md:top-[5px] py-0.5 items-center justify-center px-4 bg-indigo-500 hover:bg-indigo-600 dark:bg-indigo-500 dark:hover:bg-indigo-400 text-white rounded-full"
  //         type="submit"
