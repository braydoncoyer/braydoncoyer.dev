...
One of the main responsibilities when building components is to consider autonomy and reusability - and rightfully so! Architecting components in a reusable way allows optimal flexibility and speeds up development.
...
Bit comes with its on version manager, the BVM.
...
In order for teams to use components you create, they need to exported for consumption. [Bit.dev](https://harmony-docs.bit.dev/bit-dot-dev/bit-dev) is a component cloud solution for hosting and collaborating on Bit components. It’s free and offers premium options for teams. You can also publish components directly to NPM if that’s more your style!
